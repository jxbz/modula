...
So, you want to scale your training, huh? The good news first: it's not too difficult, and boils down to a few simple principles and some basic linear algebra. The bad news? It requires unlearning a few concepts you may have been taught in lectures. For example, consider the following principle:
...
Now, let's apply the golden rules to understand how to do width scaling, depth scaling. This should already be enough for you to get started scaling a GPT.
